...
const ExampleModal = () => (
  <div>
    ...
    Donec eu justo vitae mauris facilisis cursus facilisis nec libero. Donec consequat dictum leo.
    ...
    Aenean fermentum feugiat venenatis. Nunc posuere erat nunc, quis vestibulum ipsum pretium sed.
    Curabitur pharetra mauris vitae porta molestie. Mauris
    id ex id sem porta dignissim mollis eu eros.
    In quis euismod leo, quis auctor magna. Vestibulum congue nibh non quam elementum molestie.
    Mauris ut vestibulum libero. Cras venenatis odio quis augue congue ullamcorper.
    Curabitur a felis in magna blandit hendrerit. Donec commodo diam eget nunc laoreet dignissim.
    Nullam viverra malesuada augue. Suspendisse et lacinia leo.
    Nam ipsum massa, sagittis congue sollicitudin eu, tincidunt et ligula.
    Donec libero dolor, feugiat at ultrices nec, finibus eu quam. Sed vel cursus arcu.
    Morbi rutrum dolor est, vel dictum neque tempor ac.
    ...
    Integer dapibus nulla eu justo vulputate volutpat. Morbi mollis elit eu ex condimentum tempus.
    ...
    elementum orci quis quam rhoncus malesuada. Integer tempor a felis quis
    sollicitudin. Quisque tincidunt ex quam, sit amet placerat risus sagittis
    ut. Nunc facilisis sapien sed diam maximus, vitae volutpat neque sodales.
  </div>
);
